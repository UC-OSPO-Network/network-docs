...
- UC pipeline is the proof that research → global infrastructure is a pattern, not a fluke (details on next slide)
...
::: {.notes}
- Most direct connection to IASSIST members' world
...
::: {.notes}
- Two years in, the model works
- Open question: moving from grant funding to permanent infrastructure — working on Sloan extension, exploring UCOP pathways
- The pattern (distributed nodes, shared governance, thematic working groups) is transferable to any large university system
:::
...
::: {.notes}
- This is the invitation: IASSIST members should be at the OSPO table — you work across the research lifecycle, understand data governance, run training programs
...
🖥 Slides: **[tinyurl.com/iassist2026](https://tinyurl.com/iassist2026)**

📄 Handout: **[tinyurl.com/iassist2026-handout](https://tinyurl.com/iassist2026-handout)**

📑 PDF: **[download on Zenodo](https://zenodo.org/records/20498692)**
