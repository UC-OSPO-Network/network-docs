...
a.resource-file:hover { color: var(--blue); }
...
<div class="handout-header">
  <img src="images/uc-ospo-favicon.png" alt="UC OSPO Network">
  <div class="handout-header-text">
    <h1>UC Open Source as Institutional Infrastructure</h1>
    <p>Tim Dennis &middot; UCLA OSPO Lead, UC OSPO Network &middot; <abbr title="International Association for Social Science Information Service and Technology">IASSIST</abbr> 2026 &middot; Slides: <strong>tinyurl.com/iassist2026</strong> &middot; Handout: <strong>tinyurl.com/iassist2026-handout</strong></p>
  </div>
</div>
...
<div class="right-col">
  ...
  <div class="panel">
    ...
    <div class="panel-body">
      <div class="resource-row"><a class="resource-file" href="https://ucospo.net/oss-resources/template-guides/readme-guide/">README.md</a> template + guide</div>
      <div class="resource-row"><a class="resource-file" href="https://ucospo.net/oss-resources/template-guides/license-guide/">LICENSE</a> guide with UC-approved options</div>
      <div class="resource-row"><a class="resource-file" href="https://ucospo.net/oss-resources/template-guides/contributing-guide/">CONTRIBUTING.md</a> template + guide</div>
      <div class="resource-row"><a class="resource-file" href="https://ucospo.net/oss-resources/template-guides/code-of-conduct-guide/">CODE_OF_CONDUCT.md</a> Contributor Covenant</div>
