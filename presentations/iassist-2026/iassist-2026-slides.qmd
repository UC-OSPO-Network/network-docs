...
**Software is the next frontier** — and UC has been showing the way for 50 years: BSD Unix, Apache Spark, RISC-V, Ray. The pipeline from university research to global infrastructure is not rare or accidental.
...
::: {.small}
Barker et al. (2022) doi:10.1038/s41597-022-01710-x · Ruff, UC Open 2026
:::
...
The UC pipeline is the concrete proof: BSD Unix at Berkeley, Apache Spark from the AMPLab (2009, donated to Apache; Databricks followed), RISC-V from Berkeley (2010 teaching tool, now 350+ org members in 70 countries, ships in billions of devices), Ray from the RISELab (2016 class project, donated to Linux Foundation in 2025, now core OpenAI compute infrastructure). Ruff's point: "The students writing their class projects this very semester may be creating the next Ray." That is not a metaphor. It is a track record.
:::
