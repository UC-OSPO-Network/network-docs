...
<span class="project-badge">BSD Unix</span>
</div>
</div>
...
<span class="project-badge">UCSD Pascal</span>
</div>
</div>
...
<div class="logo-row">
<span class="project-badge">Named Data Networking</span>
...
<span class="project-badge">OpenMM</span>
</div>
</div>
...
::: {.notes}
The Gemini research surfaced this breadth — systems infrastructure (Berkeley, UCSC), bioinformatics and neuroscience pipelines (UCSD, UCSF, Davis), and internet infrastructure (UCLA). Berkeley gets the headline logos because those are the ones your audience already uses or has heard of. But the point is the pattern: grant-funded university research, permissive license, donated to a foundation or commercialized and then open, now embedded in global systems.

UCSD Pascal in 1979 was doing virtual machine portability before Java. The tz database is in every OS clock on the planet. UCSC's Genome Browser hosted the first public human genome assembly. This is not a short list of lucky accidents.
:::
