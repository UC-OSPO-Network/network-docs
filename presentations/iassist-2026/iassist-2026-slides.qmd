...
Put it in your portfolio. Teach it to your students. You don't need a formal OSPO to do OSPO work — you need the frame.
:::
...
Solving the immediate need is necessary.

Moving researchers one standard deviation in their practice — from "it runs on my machine" toward maintainable, licensed, citable software — is what **compounds**.
:::
...
::: {.notes}
The 1σ framing is the core of this slide. The goal is not to turn every data librarian into an OSPO director. The goal is to shift what a researcher walks away from a consultation knowing. If they leave with a license file and a CITATION.cff, that is a one-time fix. If they leave understanding *why* those things matter — for reproducibility, for credit, for compliance — that is a shift in practice that compounds across their lab, their students, their next grant.
