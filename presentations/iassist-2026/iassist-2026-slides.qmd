...
Most institutions have no coordinated support for the people keeping it running.
...
Start with what this room knows. 92% of researchers depend on software; two-thirds say their work would stop without it. When a maintainer burns out, a key library gets abandoned. A licensing question blocks a publication. There is often nowhere to turn. That is the gap.
:::
...
FAIR did not happen by accident. It happened because data professionals insisted that data deserved first-class treatment as a scholarly output. We are at that same point with software. Researchers already know their code matters. What is missing is the institutional scaffolding. That is what OSPOs provide, and it is why this is a data services story, not just a software story.
:::
...
::: {.column width="33%"}
::: {style="background:#f0f4fa; border-radius:8px; padding:1.4em 1em; text-align:center; height:320px;"}
[🔭]{style="font-size:3em;"}
...
* Reproducibility tooling ↔ FAIR principles
...
::: {.notes}
This is the invitation. IASSIST members are exactly the people who should be at the OSPO table. You work across the research lifecycle, you understand data governance, you run training programs. The question is whether your institution has made the connection yet.
:::
