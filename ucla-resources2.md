...
**Confirmed & Expanded.** UCLA researchers have access to institutional, UC-wide, and specialized clinical/protected repositories:

- [UCLA Dataverse](https://dataverse.ucla.edu/), a local, general-purpose repository managed by the UCLA Library Data Science Center (DSC) for publishing, sharing, and preserving research data.  
- [Dryad](https://datadryad.org/), a UC-managed generalist data repository available at no cost to UC researchers.  
- [Vivli](https://vivli.org/), an institutional platform for sharing and archiving clinical research and human subjects data in compliance with participant privacy and security standards. UCLA is an official Vivli member institution.  
- [Protocols.io](https://www.library.ucla.edu/help/services-resources/open-science-services/) for step-by-step experimental methods and workflows.  
- [eScholarship](https://escholarship.org/) (UC’s open access publishing platform) and NIH-recommended domain-specific repositories.

**NIH Data Management & Sharing (DMS) Compliance:** UCLA Research & Creative Activities recommends a tiered approach for NIH-funded data preservation:
1. *Domain-Specific Repositories:* Preferred whenever available for richer metadata and community standards.
2. *Generalist Repositories:* UCLA Dataverse or Dryad for general datasets lacking a dedicated domain archive.
3. *Protected Repositories:* Vivli or specialized secure enclaves for sensitive, de-identified clinical or PII/PHI data.

The best starting point is the UCLA Library’s [Open Science Services](https://www.library.ucla.edu/help/services-resources/open-science-services/). Staff provide consultations on repository selection, data management and sharing plans (DMPs), persistent identifiers (DOIs), and open science workflows.
...
**Confirmed.** UCLA provides institutional access to the [SPIN funding opportunity database](https://www3.research.ucla.edu/reo/fundopps), accessible to UCLA faculty, staff, and students via Single Sign-On (SSO). REO maintains lists of federal, foundation, corporate, and internal opportunities and provides customized search assistance.
...
| **Clinical Data Sharing** | UCLA Library DSC / Vivli Portal | Office of Human Research Protection (OHRPP) |
