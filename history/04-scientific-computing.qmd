...
::: {.origin-story}
*Draft - fill in: Berkeley's AMPLab (Algorithms, Machines, and People); Matei Zaharia's classmate Lester Mackey needing faster distributed machine learning to compete in the $1M Netflix Prize; Zaharia building Spark as a solution; the key insight that Hadoop MapReduce was too slow for iterative ML algorithms because it wrote to disk between every step; Spark's in-memory execution model; the donation to Apache before commercializing; Databricks founded after the donation; Databricks now valued at $62B+.*
:::
